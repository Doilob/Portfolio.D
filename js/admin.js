document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderAdminList() {
    ...
    projects.forEach((proj, idx) => {
      let statusBg = '#c84b29'; // IN PROGRESS
      if (proj.status === 'COMPLETED') statusBg = '#2d6a4f'; // COMPLETED
      if (proj.status === 'DROPPED') statusBg = '#6c757d';   // DROPPED
  ...
  // 5. 프로젝트 추가 폼 제출 처리 (Save Project)
  ...
  // 6. JSON 다운로드 버튼 처리 (Download projects.json)
